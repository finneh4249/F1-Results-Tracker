...
class Menu(app_structures.BaseMenu):
    ...
    def view_poles(self):
        ...
        results = db_structures.get_topten_results("driver", "total_pole_positions")
    ...
    def view_fastest_lap(self):
        ...
        results = db_structures.get_topten_results("driver", "total_fastest_laps")
        print(green + "Getting Results...")
    ...
    def view_champs(self):
        ...
        results = db_structures.get_topten_results("driver", "total_championship_wins")
        print(green + "Getting Results...")
    ...
    def view_podiums(self):
        ...
        results = db_structures.get_topten_results("driver", "total_podiums")
        print(green + "Getting Results...")
    ...
    def view_points(self):
        ...
        results = db_structures.get_topten_results("driver", "total_championship_points")
        print(green + "Getting Results...")
    ...
    def view_wins(self):
        ...
        results = db_structures.get_topten_results("driver", "total_race_wins")
        print(green + "Getting Results...")
